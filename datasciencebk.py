...
Original file is located at
    https://colab.research.google.com/drive/1rLLsue6u4e-4MXrwIAc-IefZLhOMgt48
...
fill_value = {'trestbps': meanTBPS, 'chol': meanChol, 'fbs': meanfbs,
              'thalach': meanthalach, 'exang': meanexang, 'restecg': meanRestCG}
dfClean = df_selected.fillna(value=fill_value)

dfClean.info()

dfClean.isnull().sum()

"""melalukan pengecekan terhadap duplikaksi data dan melakukan penghapusan terhadap duplikasi data"""
